...
cd /opt/
download "https://github.com/emengweb/cdnflydadao/raw/main/cdnfly/v5.1.13/master/$tar_gz_name" "https://github.com/emengweb/cdnflydadao/raw/main/cdnfly/v5.1.13/master/$tar_gz_name" "$tar_gz_name"
...
if [ -f /opt/cdnfly/master/view/upgrade.so ]; then
	wget https://github.com/emengweb/cdnflydadao/raw/main/cdnfly/api.py -O /opt/venv/lib/python2.7/site-packages/requests/api.py
