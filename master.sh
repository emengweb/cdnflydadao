...
cd /opt/
download "https://github.com/emengweb/cdnflydadao/raw/main/master/$tar_gz_name" "https://github.com/emengweb/cdnflydadao/raw/main/master/$tar_gz_name" "$tar_gz_name"
